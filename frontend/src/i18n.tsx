...
const STRINGS: Record<string, string> = {
  ...
  homeIndustryWindSub: "从近两周高热讨论中 AI 归纳具体热点（产品/场景/现象），不是固定赛道；条越长表示该方向越热",
  ...
  resourcesReplicationAll: "全部（默认）",
  resourcesReplicationSa: "S + A 档",
  resourcesReplicationS: "仅 S 档",
  resourcesReplicationHint:
    "默认展示全部应用与工具；可选「有深度评估」仅看完整复刻分析且价值分≥7 的条目。时间范围默认近 7 天，可改上方日期筛选。",
