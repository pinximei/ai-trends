...
const STRINGS: Record<string, string> = {
  ...
  navApps: "AI 工具",
  navNews: "AI 资讯",
  seoTrendsDescription:
    "发现持续升温的 AI 软件、开源仓库、资讯热点与话题赛道：结合热度、跨日同步与 GitHub 增速识别行业趋势。",
  ...
  trendsOssSub: "GitHub Trending 等仓库，含今日 star 增速信号",
  trendsHotspotsTitle: "持续发酵的资讯热点",
  trendsHotspotsSub: "Hacker News 等讨论帖，仍在被刷新与传播",
  trendsTopicMomentum: "赛道动量",
  trendsTopicHeatAvg: "均热",
  trendsEmpty: "当前时间窗内暂无达到阈值的条目",
  trendsTopicsEmpty: "暂无聚合出的话题赛道（需同分类至少 2 篇高动量文章）",
  trendsLoadError: "加载趋势数据失败",
  trendsPeriodNote: "统计近",
  trendsPeriodDaysUnit: "天入库内容",
  homeTrendsLink: "查看持续升温榜 →",
  navDownloads: "软件下载",
  navAbout: "关于我们",
