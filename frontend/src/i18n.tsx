...
const STRINGS: Record<string, string> = {
  ...
  homeIndustryWindSub: "从高热讨论中 AI 归纳具体热点；环比为本周 vs 上周，条越长表示本周该方向越热",
  homeIndustryWindSubChart: "实线为本周每日相关文章数，虚线为上周；悬停查看各热点走势与环比",
  homeIndustryWindViewToggle: "行业风向展示方式",
  homeIndustryWindViewRank: "排行",
  homeIndustryWindViewChart: "折线图",
  homeIndustryWindChartHint: "每条彩色线为一条热点：实线=本周，虚线=上周；横轴为全部日期",
  ...
  homeTrendVsWindHint: "行业话题走势与本周/上周对比请见上方「行业风向」。",
  homeTrendYUnit: "篇/日",
  homeTrendXAxis: "日期",
